...
namespace Q126
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(FormatCoins_A("JOSÉ PEREZ", 40));
            ...
            Console.WriteLine(FormatCoins_D("JOSÉ PEREZ", 40));
        ...
        {
            return string.Format("Player {0} collected {1:D1} coins", name, coins);
        }
    }
}
